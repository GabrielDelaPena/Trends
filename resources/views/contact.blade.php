...
<head>
    ...
    <link rel="stylesheet" a href="{{ url('css/contact.css') }}">
...
<body>
    ...
    <main>
        <!-- Sectie 1 : Titel "Contact" en de Form -->
        <section>
            <h2>Contact</h2>
            <div class="display-flex">
                <div class="sectie1">
                    <div id="container1">
                        <h1>&bull; 't Festival &bull;</h1>
                        <div class="underline">
                        </div>
                        ...
                        <form action="kevin.tfestival@gmail.be" method="post" id="contact_form">
                            <div class="name">
                                <label for="name"></label>
                                <input type="text" placeholder="Mijn naam is" name="name" id="name_input" required>
                            </div>
                            <div class="email">
                                <label for="email"></label>
                                <input type="email" placeholder="Mijn email is" name="email" id="email_input" required>
                            </div>
                            <div class="telephone">
                                <label for="name"></label>
                                <input type="text" placeholder="Mijn telefoonnummer is" name="telephone" id="telephone_input" required>
                            </div>
                            <div class="subject">
                                <label for="subject"></label>
                                <select placeholder="Subject line" name="subject" id="subject_input" required>
                                    <option disabled hidden selected>Onderwerp</option>
                                    <option>Ik heb een probleem</option>
                                    <option>Ik heb een vraag</option>
                                    <option>Ik heb iets aan te bieden</option>
                                </select>
                            </div>
                            <div class="message">
                                <label for="message"></label>
                                <textarea name="message" placeholder="Ik wil praten over" id="message_input" cols="30" rows="5" required></textarea>
                            </div>
                            <div class="submit">
                                <input type="submit" value="VERZENDEN" id="form_button" />
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <!--Sectie 2 : Twee containers voor extra info hoofdbureau (MOET NOG GEDAAN WORDEN) -->
        <section>
            <p>Er wordt zo snel mogelijk geantwoord op mails. Indien het dringend is, u vindt hieronder alle gegevens
                van het hoofdbureau.<br>/// 2 containers - 1 voor gegevens & andere voor google maps localisatie</p>
        </section>
    </main>
