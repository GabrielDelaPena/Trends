...
<body>
    ...
    <div class="sectie1 d-flex justify-content-center">
        <h2>Druk om te betalen</h2>

        <div class="d-flex justify-content-center" style="display: flex; margin-top:50px;">
            <button class="a-tag">
                <a class="btn btn-primary" href="{{ route('processTransaction') }}" style="text-decoration: none; color: black; text-align:center;">Pay €{{ $totalPrice }}</a>
            </button>
        </div>
